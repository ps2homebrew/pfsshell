...
#define journalFlush apa_journalFlush
#define journalReset apa_journalReset
#define journalResetore apa_journalResetore
#define journalWrite apa_journalWrite
