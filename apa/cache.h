...
#define cacheAdd apa_cacheAdd
#define cacheFlushAllDirty apa_cacheFlushAllDirty
#define cacheInit apa_cacheInit
#define cacheLink apa_cacheLink
#define cacheTransfer apa_cacheTransfer
#define cacheUnLink apa_cacheUnLink
